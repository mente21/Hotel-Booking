...
const Newslatter = () => {
    return (
        // Reduced external margin and increased padding for container
        <div className="flex flex-col items-center max-w-5xl lg:w-full rounded-2xl px-4 py-20 mx-2 lg:mx-auto my-24 bg-gray-900 text-white">

            {/* Added mb-12 to explicitly set the gap between the Title and the form */}
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4">
                <input type="text" className="bg-white/10 px-4 py-2.5 border border-white/20 rounded outline-none w-full sm:max-w-66" placeholder="Enter your email" />
